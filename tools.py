...
def create_tools(**kwargs) -> AIIncidentResponseTools:
    """创建事故响应工具"""
    return AIIncidentResponseTools(**kwargs)


if __name__ == "__main__":
    tools = create_tools()

    print("AI Incident Response Tools")
    print()
